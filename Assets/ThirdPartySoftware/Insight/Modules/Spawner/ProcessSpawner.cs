    ...
    public class ProcessSpawner : InsightModule
    {
        ...
        bool InternalStartNewProcess(RequestSpawnStartMsg spawnProperties)
        {
            ...
            p.StartInfo.Arguments = ArgsString() +
                ...
                " -RoomName " + spawnProperties.RoomName +
                " -RoomCreator " + spawnProperties.RoomCreator +
                " -CreatorID " + spawnProperties.CreatorID +
                " -RoomPassword " + spawnProperties.RoomPassword +
                " -RoomMaxPlayers " + spawnProperties.RoomMaxPlayers +
                " -RoomExpireDate " + spawnProperties.RoomExpireDate;
