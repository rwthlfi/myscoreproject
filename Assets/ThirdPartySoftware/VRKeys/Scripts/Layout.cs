...
namespace VRKeys {
	...
	public class Layout {
		...
		public string[] row2Keys = { "q", "w", "e", "r", "t", "z", "u", "i", "o", "p", "[", "]", "\\" };

		public string[] row2Shift = { "Q", "W", "E", "R", "T", "Z", "U", "I", "O", "P", "{", "}", "|" };

		public string[] row3Keys = { "a", "s", "d", "f", "g", "h", "j", "k", "l", ";", "'" };

		public string[] row3Shift = { "A", "S", "D", "F", "G", "H", "J", "K", "L", ":", "\"" };

		public string[] row4Keys = { "y", "x", "c", "v", "b", "n", "m", ",", ".", "?" };

		public string[] row4Shift = { "Y", "X", "C", "V", "B", "N", "M", "<", ">", "/" };
