...
namespace VRKeys {
	...
	public class Keyboard : MonoBehaviour {
		...
		//reference for keyboardListener
		...
		private IEnumerator Start () {
			...
			initialized = true;
			keyboardListener = GetComponent<KeyboardListener>();
		}
		...
		public void SetText (string txt) {
			...
			if (keyboardListener)
			{
				keyboardListener.VuplexListener("Clear");
			}
		}
		...
		public void AddCharacter (string character) {
			...
			//Update the text in the webbrowser in case it exist
			if (keyboardListener)
            {
				keyboardListener.VuplexListener(character);
			}
		...
		public void Backspace () {
			...
			if (keyboardListener)
				keyboardListener.VuplexListener("Backspace");
		}
		...
		public void Submit () {
			...
			if (keyboardListener)
				keyboardListener.VuplexListener("Enter");
		}
