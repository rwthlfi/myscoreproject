...
namespace AvatarCreation
{
    public class LowerBodyAnimation : MonoBehaviour
    {
        ...
        private void OnAnimatorIK(int layerIndex)
        {
            ...
            bool isLeftFootDown = Physics.Raycast(leftFootPos + this.raycastOffsetLeft, Vector3.down, out hitLeftFoot, 1000f, castLayer.value);
            bool isRightFootDown = Physics.Raycast(rightFootPos + this.raycastOffsRight, Vector3.down, out hitRightFoot, 1000f, castLayer.value);
