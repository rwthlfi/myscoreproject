...
public class MyScoreLocalServerBuild_Windows
{
    public static string ScenesRoot = "Assets/Scenes/";
    public static string ServerRoot = "Servers/LocalServers/";
    ...
    public static string buildPath = "Builds/Locals/";

    [MenuItem("Tools/Build Local MyScoreServer Windows/Build All", false, 0)]
    ...
    [MenuItem("Tools/Build Local MyScoreServer Windows/MasterServer", false, 100)]
    ...
    [MenuItem("Tools/Build Local MyScoreServer Windows/RemoteSpawner", false, 101)]
    ...
    [MenuItem("Tools/Build Local MyScoreServer Windows/GameServer", false, 102)]
    ...
    [MenuItem("Tools/Build Local MyScoreServer Windows/PlayerClient", false, 103)]
