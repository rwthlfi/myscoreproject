...
public class MyScoreServerBuild_LinuxScript
{
    public static string ScenesRoot = "Assets/Scenes/Servers/";
    public static string ServerRoot = "LinuxServers/";
    private static readonly BuildTarget buildTarget = BuildTarget.StandaloneLinux64;
    ...
    public static string buildPath = "Builds/Linux/";

    [MenuItem("Tools/Build MyScoreServer Linux/Build All", false, 0)]
    ...
    [MenuItem("Tools/Build MyScoreServer Linux/MasterServer", false, 100)]
    ...
    [MenuItem("Tools/Build MyScoreServer Linux/RemoteSpawner", false, 101)]
    ...
    [MenuItem("Tools/Build MyScoreServer Linux/GameServer", false, 102)]
    ...
    [MenuItem("Tools/Build MyScoreServer Linux/PlayerClient", false, 103)]
    ...
    public static void BuildMasterServer(string path)
    {
        ...
        */
        ...
        buildPlayerOptions.locationPathName = buildPath + "MasterServer.x86_64";
    ...
    public static void BuildRemoteSpawner(string path)
    {
        ...
        */
        ...
        buildPlayerOptions.locationPathName = buildPath + "RemoteSpawner.x86_64";
        buildPlayerOptions.target = buildTarget;
        buildPlayerOptions.options = buildOptions;
        BuildPipeline.BuildPlayer(buildPlayerOptions);
    ...
    public static void BuildGameServer(string path)
    {
        string[] gameServerScenes = new[]
        {
            ...
            ScenesRoot+"RWTHUniversity.unity"
        };
        ...
        */
        ...
        BuildPlayerOptions buildPlayerOptions = new BuildPlayerOptions();
        buildPlayerOptions.scenes = gameServerScenes;
        buildPlayerOptions.locationPathName = buildPath + "GameServer.x86_64";
        buildPlayerOptions.target = buildTarget;
        buildPlayerOptions.options = buildOptions;
        BuildPipeline.BuildPlayer(buildPlayerOptions);
    }
    ...
    public static void BuildPlayerClient(string path)
    {
        string[] scenes = new[]
        {
            ScenesRoot + "WelcomeScene_NEW.unity",
            //Scene used for MasterServer Demo
            ScenesRoot+"Katschhof_URP.unity",
            ScenesRoot+"RolePlayHall.unity",
            ScenesRoot+"Rektoratsraum_URP.unity",
            ScenesRoot+"BarScene.unity",
            ScenesRoot+"MobileFloodScene_URP.unity",
            ScenesRoot+"ScoutScene.unity",
            ScenesRoot+"MatrixScene.unity"
        };
        /*
        ...
        */
        ...
        BuildPlayerOptions buildPlayerOptions = new BuildPlayerOptions();
        buildPlayerOptions.scenes = scenes;
        buildPlayerOptions.locationPathName = buildPath + "PlayerClient.x86_64";
        buildPlayerOptions.target = buildTarget;
        buildPlayerOptions.options = buildOptions;
        BuildPipeline.BuildPlayer(buildPlayerOptions);
    }
