...
public class MyScoreServerBuild_WindowsScript
{
    public static string ScenesRoot = "Assets/Scenes/";
    public static string ServerRoot = "Servers/WindowsServers/";
    ...
    public static string buildPath = "Builds/WindowsAppLab/";

    [MenuItem("Tools/Build MyScoreServer Windows/Build All", false, 0)]
    ...
    [MenuItem("Tools/Build MyScoreServer Windows/MasterServer", false, 100)]
    ...
    [MenuItem("Tools/Build MyScoreServer Windows/RemoteSpawner", false, 101)]
    ...
    [MenuItem("Tools/Build MyScoreServer Windows/GameServer", false, 102)]
    ...
    [MenuItem("Tools/Build MyScoreServer Windows/PlayerClient", false, 103)]
